...
; (function() {
    ...
    var Table = {
        ...
        'plant' : [
            ...
            { id : 3, name : "枸杞", buy : 150, sellPrice : 75, fruit : { name : "枸杞", price : 3 }, output : 100, minLevel:9, time:{amount:90, part:[30,30,30],images:["zhongZi","youmiao","3_2","3_3","canliu"],imagesModify:[null,null,{ox:0,oy:-10,sx:1.2,sy:1.2},{ox:-2,oy:-10,sx:1.0,sy:1.0},null]}, headImagPath : "plant/3_2", disasterId : 1, sowExp:50, harvestExp:110, clearExp:50},
