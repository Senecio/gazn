...
; (function() {
    ...
    var Table = {
        ...
        'plant' : [
            ...
            { id : 5, name : "红枣", buy : 250, sellPrice : 90, fruit : { name : "红枣", price : 5 }, output : 100, minLevel:1, time:{amount:150, part:[50,50,50],images:["zhongZi","youmiao","5_2","5_3","canliu"],imagesModify:[null,null,{ox:-1,oy:-10,sx:1.2,sy:1.2},{ox:-1,oy:-10,sx:1.0,sy:1.0},null]}, headImagPath : "plant/5_2", disasterId : 1, sowExp:100, harvestExp:125, clearExp:100},
